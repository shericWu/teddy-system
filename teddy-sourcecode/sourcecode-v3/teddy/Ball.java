...
class Ball extends Polyhedron {
   Ball() {
      ...
      double[] var9 = new double[]{1.0, var1, var5, var3, 0.0, -var3, -var5, -var1, -1.0};
      double[] var10 = new double[]{0.0, var3, var5, var1, 1.0, var1, var5, var3, 0.0};
      ...
      do {
         super.tmp_polygons
            .append(
               new Polyhedron.TmpPolygon(
                  this,
                  this.get_vertex(var10[7] * var11[var8][0], var10[7] * var11[var8][1], var9[7]),
                  this.get_vertex(0.0, 0.0, var9[8]),
                  this.get_vertex(var10[7] * var11[var8 + 1][0], var10[7] * var11[var8 + 1][1], var9[7])
               )
            );
      } while (++var8 <= 15);
